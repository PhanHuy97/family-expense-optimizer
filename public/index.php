...
$router->get('/purchase-plans', [App\Controllers\PurchasePlanController::class, 'index']);
$router->get('/purchase-plans/create', [App\Controllers\PurchasePlanController::class, 'create']);
$router->post('/purchase-plans', [App\Controllers\PurchasePlanController::class, 'store']);
$router->post('/purchase-plans/delete', [App\Controllers\PurchasePlanController::class, 'delete']);
